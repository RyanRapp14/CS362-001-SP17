...
public class ApptRandomTest {
	...
	private static final long TestTimeout = 120000; /* Timeout at 60 seconds */
		...
		for (int iteration = 0; elapsed < TestTimeout; iteration++) {
			...
			for (int i = 0; i < NUM_TESTS; i++) {
				...
				if (methodName.equals("setTitle")){
					...
					int newVal = (int) ValuesGenerator.getRandomIntBetween(random, -100, 100);
